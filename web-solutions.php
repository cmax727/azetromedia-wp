  ...
  <div class="center-align">
   <div class="wrp ">
    <hgroup>
     ...
     <h1><?php echo get_option('title_but1');?></h1>
     <h3><?php echo get_option('sub_title_but1');?></h3>
    </hgroup>
   </div>
   <div id="tabs" >
    <div class="wrp tabs">
     <ul class="nav">
      <li class="one"><a href="#one" class="current"><?php echo get_option('button_heading11');?></a></li>
      <li class="two"><a href="#two"><?php echo get_option('button_heading21');?></a></li>
      <li class="three"><a href="#three"><?php echo get_option('button_heading31');?></a></li>
      <li class="four"><a href="#four"><?php echo get_option('button_heading41');?></a></li>
      <li class="five"><a href="#five"><?php echo get_option('button_heading51');?></a></li>
     </ul>
     <div class="tabs-Cnt" id="one">
      <p style="text-align:left;"><?php echo get_option('buton_description11');?></p>
     </div>
     <div class="tabs-Cnt hide" id="two">
      <p  style="text-align:left;"><?php echo get_option('buton_description21');?></p>
     </div>
     <div class="tabs-Cnt hide" id="three">
      <p  style="text-align:left;"><?php echo get_option('buton_description31');?></p>
     </div>
     <div class="tabs-Cnt hide" id="four">
      <p  style="text-align:left;"><?php echo get_option('buton_description41');?></p>
     </div>
     <div class="tabs-Cnt hide" id="five">
      <p  style="text-align:left;"><?php echo get_option('buton_description51');?></p>
     </div>
    </div>
   </div>
   <div class="wrp ">
